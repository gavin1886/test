...
function updatePriceAndDevelopmentTime(pageScaleRating, appTypeRating, dataScaleRating, uiDesignRating) {
    ...
    // 更新DOM
    document.getElementById('baseDevFee').textContent = `${baseDevFee}元`;
    document.getElementById('uiDesignFee').textContent = `${uiDesignFee}元`;
    document.getElementById('serverFee').textContent = `${serverFee}元/年`;
    document.getElementById('serverFee2').textContent = `${serverFee}元/年`;
    document.getElementById('wechatCertFee').textContent = `${wechatCertFee}元/年`;
    document.getElementById('wechatCertFee2').textContent = `${wechatCertFee}元/年`;
    document.getElementById('sslCertFee').textContent = `${sslCertFee}元/年`;
    document.getElementById('sslCertFee2').textContent = `${sslCertFee}元/年`;
    document.getElementById('otherFee').textContent = `${otherFee}元`;
    document.getElementById('versionFactor').textContent = version === 'enterprise' ? '1.0 (企业版)' : '0.6 (个人版)';
    document.getElementById('totalPrice').textContent = `${totalPrice}元`;
    document.getElementById('maintenanceFee').textContent = `${maintenanceFee}元/年`;
    document.getElementById('subsequentYearFee').textContent = `${subsequentYearFee}元/年`;
    
    // 更新摘要
    document.getElementById('firstYearPrice').textContent = `${totalPrice}元`;
    document.getElementById('yearlyPrice').textContent = `${subsequentYearFee}元/年`;
    document.getElementById('developmentTime').textContent = developmentTime;
